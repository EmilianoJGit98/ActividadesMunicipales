...
export class ActividadesMunicipalesService {  
  private apiUrl = 'http://192.168.0.248:3002/api/municipalidad-mp/listar-actividades'; // Reemplaza con tu URL de API real  
